...
public class ControladorTaco {
    ...
    public void cargarComboboxss(JComboBox combobox_Tortilla, JComboBox combobox_Alimento, JComboBox combobox_Salsa) {
        ...
        if (listaAlimentos.isEmpty()) {
            JOptionPane.showMessageDialog(null, "No tiene alimentos cargados", "ERROR", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        } else {
            if (listaTortillas.isEmpty()) {
                JOptionPane.showMessageDialog(null, "No tiene tortillas cargadas", "ERROR", JOptionPane.ERROR_MESSAGE);
                System.exit(0);
            } else {
                if (listaSalsas.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "No tiene salsas cargadas", "ERROR", JOptionPane.ERROR_MESSAGE);
                    System.exit(0);
                }
            }
        }
    ...
    public boolean agregarTaco(double importe, DefaultTableModel dtmTortilla, DefaultTableModel dtmSalsa, DefaultTableModel dtmAlimento) {
        ...
        try {
            if (validarTablas(dtmTortilla, dtmAlimento) == true) {
                ...
                JOptionPane.showMessageDialog(null, "Debe seleccionar por lo menos una tortilla y un alimento", "ERROR", JOptionPane.ERROR_MESSAGE);
                return false;
            }
    ...
    public boolean modificarTaco(int idtacobuscado, DefaultTableModel dtmTortilla, double importe, DefaultTableModel dtmAlimento, DefaultTableModel dtmSalsa) {
        try {
            if (validarTablas(dtmTortilla, dtmAlimento) == true) {
                ...
                JOptionPane.showMessageDialog(null, "Tiene que seleccionar por lo menos una tortilla y un alimento", "ERROR", JOptionPane.ERROR_MESSAGE);
                return false;
            }
